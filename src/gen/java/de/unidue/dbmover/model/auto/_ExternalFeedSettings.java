...
/**
 * Class _ExternalFeedSettings was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _ExternalFeedSettings extends BaseDataObject {

    private static final long serialVersionUID = 1L; 


    public static final Property<Long> FEED_ID = Property.create("feedId", Long.class);
    ...
    public void writePropertyDirectly(String propName, Object val) {
        ...
        switch (propName) {
            case "feedId":
                this.feedId = val == null ? 0 : (long)val;
                break;
            case "locale":
