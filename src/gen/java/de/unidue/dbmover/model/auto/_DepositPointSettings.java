...
/**
 * Class _DepositPointSettings was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _DepositPointSettings extends BaseDataObject {

    private static final long serialVersionUID = 1L; 


    public static final Property<Long> DEPOSIT_POINT_ID = Property.create("depositPointId", Long.class);
    ...
    public void writePropertyDirectly(String propName, Object val) {
        ...
        switch (propName) {
            case "depositPointId":
                this.depositPointId = val == null ? 0 : (long)val;
                break;
            case "locale":
    ...
    protected void writeState(ObjectOutputStream out) throws IOException {
        ...
        out.writeLong(this.depositPointId);
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        super.readState(in);
        this.depositPointId = in.readLong();
